...
namespace WebCv.Domain.Models.DataContexts
{
   public class WebCvDbContext : IdentityDbContext<CvUser, CvRole, int, CvUserClaim,
        CvUserRole,
        CvUserLogin, CvRoleClaim, CvUserToken>
    {
        public WebCvDbContext(DbContextOptions options)
            :base(options)
        {
