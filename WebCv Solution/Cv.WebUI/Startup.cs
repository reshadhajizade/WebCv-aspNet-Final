...
using WebCv.Domain.Models.DataContext;
using MediatR;
...
namespace WebCv.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<WebCvDbContext>(cfg =>
            {
                cfg.UseSqlServer(configuration.GetConnectionString("cstring"));
            })
            .AddIdentity<CvUser, CvRole>()
            .AddEntityFrameworkStores<WebCvDbContext>()
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, RoleManager<CvRole> roleManager)
        {
            ...
            app.UseStaticFiles();
            app.SeedMembership();
           WebCvDbSeed.SeedUserRole(roleManager);
