...
using WebCv.Domain.Business.ResumeModule.Diploma;
using WebCv.Domain.Business.ResumeModule.Experience;
...
namespace WebCv.WebUI.Areas.Admin.Controllers
{
   // [Authorize(Roles = "sa")]
    ...
    public class ResumeDiplomsController : Controller
    {
        ...
        public ResumeDiplomsController(WebCvDbContext db, IMediator mediator)
        {
            this.db = db;
