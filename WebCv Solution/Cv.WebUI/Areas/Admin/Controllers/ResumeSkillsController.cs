...
using WebCv.Domain.Business.BrandModule;
using WebCv.Domain.Business.ResumeModule.Skill;
...
namespace WebCv.WebUI.Areas.Admin.Controllers
{
   // [Authorize(Roles = "sa")]
    ...
    public class ResumeSkillsController : Controller
    {
        ...
        public ResumeSkillsController(WebCvDbContext db, IMediator mediator)
        {
            this.db = db;
